...
do
   ...
   sed -i -- 's/MMS/'$ms'/g' $dlnam  
   sed -i -- 's/DDS/'$ds'/g' $dlnam  
   sed -i -- 's/MME/'$me'/g' $dlnam  
   sed -i -- 's/DDE/'$de'/g' $dlnam  
   sed -i -- 's/YYYY/'$yy'/g' $dlnam  
   
   # copy over and configure the NAM dl script
   cp ../$dlndfd .     
   #sed -i -- 's/ms=XX/ms='$nms'/g' $dlnam  
   #sed -i -- 's/ds=XX/ds='$nds'/g' $dlnam  
   sed -i -- 's/MMS/'$ms'/g' $dlndfd 
   sed -i -- 's/DDS/'$ds'/g' $dlndfd 
   sed -i -- 's/HHS/'$hs'/g' $dlndfd 
   sed -i -- 's/YYYY/'$yy'/g' $dlndfd  
   ...
   sed -i -- 's/NDFDL/'$dlndfd'/g' $jobscript
