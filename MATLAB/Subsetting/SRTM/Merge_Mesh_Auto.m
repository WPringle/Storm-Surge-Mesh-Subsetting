...
DT = 10;
TS = '2019-02-27 00:00'; % simulation start time
...
m = Make_f15(m,TS,TE,DT,'const',CONST); %,'NWS',NWS,'WTIMNC',WTIMINC,'const',CONST); 

% enter in additional parameters manually
m.f15.slam = [0 0];
m.f15.runid  = 'TideOnly';
...
N_filename = '../TIDEDATA/Gridded_N_values_WOA2018_2005-2007.mat'; % this is a .mat file with gridded 
