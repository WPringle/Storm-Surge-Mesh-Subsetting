...
print([direc outname '_meshqual.png'],figres,'-dpng')
...
print([direc outname '_resomesh.png'],figres,'-dpng')
...
print([direc outname '_bathy.png'],figres,'-dpng')
...
for ii = 1:m.f13.nAttr
   ...
   m_plot(ms_poly_vec(:,1),ms_poly_vec(:,2),'k--','linew',bw);
   m_plot(track(:,1),track(:,2),'k-','linew',tw);
   print([direc outname '_' attname '.png'],figres,'-dpng')
end
...
print([direc outname '_tri+ob.png'],figres,'-dpng')
